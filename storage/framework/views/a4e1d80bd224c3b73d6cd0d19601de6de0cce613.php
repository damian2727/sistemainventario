  ...
  <aside class="main-sidebar sidebar-light-dark elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Andres Perez</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('sale.create')); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>registar venta</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('articles.create')); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Crear Articulo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('articles.index')); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Buscar Articulo</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('providers.create')); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>registrar Proveedor</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('purchase.create')); ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
