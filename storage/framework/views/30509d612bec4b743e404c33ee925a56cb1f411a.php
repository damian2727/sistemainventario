  ...
  <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><a href="<?php echo e(route('sale.index')); ?>">venta</a></h3>
        ...
        <div class="card-body">
          ...
          <?php echo Form::open(['route' => 'sale.store', 'method' => 'POST']); ?>
                  ...
                  <div class="row" style=" border-top: dotted; border-radius: 1px;">
                    ...
                    <div class="form-group" style="margin-top: 0.5em;">
                      ...
                      <select name="article_id" class="form-control selectpicker" id="article_id" data-live-search="true">
                         ...
                         <option value="<?php echo e($article->id); ?>_<?php echo e($article->stock); ?>_<?php echo e($article->preciopromedio); ?>"><?php echo e($article->article); ?></option>
                  ...
                  <div class="col-lg-3 col-sm-3 col-md-2 col-xs-12">
                   ...
                   <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                    <div class="form-group" style="margin-top: 0.5em;">
                      ...
                      <?php echo Form::number('pventa', null, ['class' => 'form-control','id'=>'pventa', 'step'=>'0.01', 'placeholder' => 'Precio venta']); ?>
